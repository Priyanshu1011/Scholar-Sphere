...
mongoose.connect(
  "mongodb+srv://priyanshupattanaik1011:XgjPcwlypDbFwJFZ@scholar-sphere-cluster.awxzp7w.mongodb.net/?retryWrites=true&w=majority&appName=scholar-sphere-cluster"
);
...
app.post("/calc-1", function (req, res) {
  const data = req.body;
  let numerator =
    Number(data.credits1) * Number(data.grade1) +
    Number(data.credits2) * Number(data.grade2) +
    Number(data.credits3) * Number(data.grade3) +
    Number(data.credits4) * Number(data.grade4) +
    Number(data.credits5) * Number(data.grade5) +
    Number(data.credits6) * Number(data.grade6) +
    Number(data.credits7) * Number(data.grade7) +
    Number(data.credits8) * Number(data.grade8) +
    Number(data.credits9) * Number(data.grade9) +
    Number(data.credits10) * Number(data.grade10) +
    Number(data.credits11) * Number(data.grade11) +
    Number(data.credits12) * Number(data.grade12) +
    Number(data.credits13) * Number(data.grade13) +
    Number(data.credits14) * Number(data.grade14) +
    Number(data.credits15) * Number(data.grade15);

  let denominator =
    Number(data.credits1) +
    Number(data.credits2) +
    Number(data.credits3) +
    Number(data.credits4) +
    Number(data.credits5) +
    Number(data.credits6) +
    Number(data.credits7) +
    Number(data.credits8) +
    Number(data.credits9) +
    Number(data.credits10) +
    Number(data.credits11) +
    Number(data.credits12) +
    Number(data.credits13) +
    Number(data.credits14) +
    Number(data.credits15);
...
app.post("/calc-2", function (req, res) {
  ...
  // console.log(data);
  const numerator =
    Number(data.calc2CurrCreds) * Number(data.calc2CurrGPA) +
    Number(data.calc2PrevCreds) * Number(data.calc2PrevGPA);
...
app.post("/calc-3", function (req, res) {
  ...
  // console.log(data);
  const num =
    Number(data.xpointer) *
      (Number(data.calc3PrevCreds) + Number(data.calc3CurrCreds)) -
    Number(data.calc3CurrCGPA) * Number(data.calc3PrevCreds);
